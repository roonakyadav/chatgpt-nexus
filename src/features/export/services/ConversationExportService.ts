...
export class ConversationExportService {
  private static readonly REPORT_JSON_FORMAT = 'gpt-nexus.report.v1' as const;

  private static readonly CHAT_JSON_FORMAT = 'gpt-nexus.chat.v1' as const;
  ...
  private static async exportDocumentPDF(
    ...
    return {
      ...
      error: 'Document PDF export is not included in GPT-nexus.',
    };
  }
