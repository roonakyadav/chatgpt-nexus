...
if [[ "$OSTYPE" == "darwin"* ]]; then
  ...
  echo ""
  echo "  xcrun safari-web-extension-converter dist_safari --app-name 'GPT-nexus' --bundle-identifier com.gpt-nexus.safari"
  echo ""
  ...
  echo ""
  echo "Safari extension conversion requires macOS with Xcode"
